...
```bash
docker pull ghcr.io/dataalgebra-engineering/pg-stress/load-generator:v1.0.0-rc14
docker pull ghcr.io/dataalgebra-engineering/pg-stress/dashboard:v1.0.0-rc14
```
