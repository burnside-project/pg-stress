...
```bash
docker pull ghcr.io/dataalgebra-engineering/pg-stress/load-generator:v1.0.0-rc15
docker pull ghcr.io/dataalgebra-engineering/pg-stress/dashboard:v1.0.0-rc15
```
